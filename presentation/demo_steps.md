...
**Expected output.** The script builds the services, waits for semantic health, and prints a local HTTPS URL. NGINX is the only service with published host ports: `8081` and `8443`.
